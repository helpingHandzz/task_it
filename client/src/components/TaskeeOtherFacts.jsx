  ...
  return (
    <>
      <button
        ...
        className="factsContainer border-4 rounded-lg p-4 text-3xl font-bold flex items-center justify-center hover:bg-cyan-600 cursor-pointer"
      >
        <div className="flex items-center">
          <h1 className="mr-4">Other Facts</h1>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            fill="currentColor"
            class="bi bi-info-circle-fill ml-4"
            viewBox="0 0 16 16"
          >
          ...
          {factsList.map((fact) => {
            return (
              <>
                ...
                {fact === "I speak multiple languages" &&
                  selectedFacts.includes(fact) && (
                    <input
                      type="text"
