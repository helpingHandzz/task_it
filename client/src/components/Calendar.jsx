...
export default function Calendar({ currentTask }) {
  ...
  const handleDayClick = (day) => {
    ...
    console.log(
      "Inside handleDayClick, taskeeId:",
      taskeeId,
      "taskerId:",
      taskerId
    );
  ...
  const isDateSelected = (day) => {
    const checkDateString = formatDate(
            ...
            <div className="px-4 flex items-center justify-between">
              ...
              <div className="flex items-center text-gray-800 dark:text-gray-100">
                <svg
                  ...
                  className="icon icon-tabler icon-tabler-chevron-left hover:bg-blue-500 rounded cursor-pointer"
                  width={24}
                  height={24}
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler ml-3 icon-tabler-chevron-right hover:bg-blue-500 rounded cursor-pointer"
                  width={24}
                  height={24}
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
              ...
              <table className="w-full">
                ...
                <tbody>
                  {Array.from(
                    {
                      length: Math.ceil(
                        (daysArray.length + firstDayOfWeek) / 7
                      ),
                    },
                    (_, rowIndex) => (
                      <tr key={rowIndex}>
                        {[...Array(7).keys()].map((dayIndex) => {
                          const day =
                            rowIndex * 7 + dayIndex + 1 - firstDayOfWeek;
                          ...
                          return (
                            <td key={day}>
                              {day > 0 && day <= daysInMonth && (
                                <div
                                  className={`px-4 py-4 cursor-pointer flex w-full justify-center rounded
                                                                ${
                                                                  isDateSelected(
                                                                    day
                                                                  )
