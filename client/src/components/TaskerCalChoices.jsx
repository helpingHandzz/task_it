...
export default function TaskerCalChoices({selectedDates}) {
    ...
    const handleSetSchedule = () => {
		...
		console.log("Inside handleSetSchedule, updatedSelectedDates:", updatedSelectedDates);
	};
                ...
                <div className="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-gray-50 rounded-b">
                    <div className="px-4">
                        <div className="border-b pb-4 border-gray-400 border-dashed flex justify-center items-center text-2xl font-medium">
                            ...
                            <select name="timeOfDay" value={startTime.timeOfDay} onChange={(e) => setStartTime({ ...startTime, timeOfDay: e.target.value })} id="selector">
