...
export default function ViewSked() {
    ...
    <div>
      ...
      {updatedSchedule.map((schedule, index) => (
        <div className="scheduleContainer border-4 rounded-lg m-4 p-4 flex items-center justify-between" key={index}>
          <h3 className="text-lg font-semibold">Date: {formatDate(schedule.date)}</h3>
          <h4 className="text-md font-semibold">Start Time: {formatTime(schedule.startTime)}</h4>
          <h4 className="text-md font-semibold">End Time: {formatTime(schedule.endTime)}</h4>
          <div className="iconContainer flex items-center space-x-6">
		  	<Link to="/calendar">
			<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-pencil-square hover:text-cyan-700 cursor-pointer" viewBox="0 0 16 16">
            	<path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
            	<path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
         	 </svg>
			  </Link>
          	<svg onClick={() => handleDeleteClick(schedule.id)} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-trash hover:text-red-500 cursor-pointer" viewBox="0 0 16 16">
