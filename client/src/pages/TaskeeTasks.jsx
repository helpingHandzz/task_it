    ...
    <div>
      {taskee && (
        <>
          ...
          <h2 className="border-4 m-4 rounded-lg bg-green-400 border-green-400 text-center text-2xl font-bold">
            Tasks In Progress
          </h2>
          {incompleteTasks?.length > 0 ? (
            ...
            <p className="border-4 m-4 rounded-lg bg-green-400 border-green-400 text-cente text-2xlr font-bold">
              No tasks in progress.
            </p>
          )}

          <h2 className="border-4 m-4 rounded-lg bg-sky-400 border-sky-400 text-center text-2xl font-bold">
            Completed Tasks
          </h2>
          {completedTasks?.length > 0 ? (
            ...
            <p className="border-4 m-4 rounded-lg bg-sky-400 border-sky-400 text-center text-2xl font-bold">
              No completed tasks.
            </p>
          )}
        </>
